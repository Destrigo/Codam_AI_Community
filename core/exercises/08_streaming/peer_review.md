# Peer Review — 08 — Streaming

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 08_streaming --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 08_streaming --lang python`
...
```bash
codamlings review approve 08_streaming --lang python --reviewer YOUR_NAME
```
