...
## Before review
- [ ] Your code runs: `codam-labs run 08_streaming --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 08_streaming --lang python`
...
```bash
codam-labs review approve 08_streaming --lang python --reviewer YOUR_NAME
```
