# Peer Review — 05 — System Prompt and User Prompt

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 05_system_user_prompts --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 05_system_user_prompts --lang python`
...
```bash
codamlings review approve 05_system_user_prompts --lang python --reviewer YOUR_NAME
```
