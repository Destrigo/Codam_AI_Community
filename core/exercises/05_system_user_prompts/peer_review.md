...
## Before review
- [ ] Your code runs: `codam-labs run 05_system_user_prompts --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_system_user_prompts --lang python`
...
```bash
codam-labs review approve 05_system_user_prompts --lang python --reviewer YOUR_NAME
```
