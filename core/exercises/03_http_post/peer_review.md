# Peer Review — 03 — HTTP POST

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 03_http_post --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_http_post --lang python`
...
```bash
codamlings review approve 03_http_post --lang python --reviewer YOUR_NAME
```
