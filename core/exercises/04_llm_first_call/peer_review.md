...
## Before review
- [ ] Your code runs: `codam-labs run 04_llm_first_call --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 04_llm_first_call --lang python`
...
```bash
codam-labs review approve 04_llm_first_call --lang python --reviewer YOUR_NAME
```
