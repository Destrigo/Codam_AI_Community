# Peer Review — 04 — First LLM Call

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_llm_first_call --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_llm_first_call --lang python`
...
```bash
codamlings review approve 04_llm_first_call --lang python --reviewer YOUR_NAME
```
