...
## Before review
- [ ] Your code runs: `codam-labs run 06_conversation_history --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 06_conversation_history --lang python`
...
```bash
codam-labs review approve 06_conversation_history --lang python --reviewer YOUR_NAME
```
