# Peer Review — 06 — Conversation History

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 06_conversation_history --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 06_conversation_history --lang python`
...
```bash
codamlings review approve 06_conversation_history --lang python --reviewer YOUR_NAME
```
