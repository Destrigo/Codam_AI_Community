# Peer Review — 09 — Timeout and Retry

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 09_timeout_retry --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 09_timeout_retry --lang python`
...
```bash
codamlings review approve 09_timeout_retry --lang python --reviewer YOUR_NAME
```
