...
## Before review
- [ ] Your code runs: `codam-labs run 07_output_control --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 07_output_control --lang python`
...
```bash
codam-labs review approve 07_output_control --lang python --reviewer YOUR_NAME
```
