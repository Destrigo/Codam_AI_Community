# Peer Review — 07 — Temperature and max_tokens

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 07_output_control --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 07_output_control --lang python`
...
```bash
codamlings review approve 07_output_control --lang python --reviewer YOUR_NAME
```
