# Peer Review — 10 — Extracting JSON from Dirty Responses

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 10_dirty_json --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 10_dirty_json --lang python`
...
```bash
codam-labs review approve 10_dirty_json --lang python --reviewer YOUR_NAME
```
