# Peer Review — Retry Invalid JSON

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 03_retry_invalid --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_retry_invalid --lang python`
...
```bash
codamlings review approve 03_retry_invalid --lang python --reviewer YOUR_NAME
```
