...
## Before review
- [ ] Your code runs: `codamlings run 05_extract_entities --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 05_extract_entities --lang python`
...
```bash
codamlings review approve 05_extract_entities --lang python --reviewer YOUR_NAME
```
