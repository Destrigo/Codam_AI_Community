# Peer Review — Entity Extraction

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 05_extract_entities --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_extract_entities --lang python`
...
```bash
codam-labs review approve 05_extract_entities --lang python --reviewer YOUR_NAME
```
