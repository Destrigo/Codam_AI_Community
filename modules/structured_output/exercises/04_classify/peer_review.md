...
## Before review
- [ ] Your code runs: `codamlings run 04_classify --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_classify --lang python`
...
```bash
codamlings review approve 04_classify --lang python --reviewer YOUR_NAME
```
