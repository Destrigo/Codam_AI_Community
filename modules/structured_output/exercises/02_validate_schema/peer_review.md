# Peer Review — Validate Schema

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 02_validate_schema --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 02_validate_schema --lang python`
...
```bash
codamlings review approve 02_validate_schema --lang python --reviewer YOUR_NAME
```
