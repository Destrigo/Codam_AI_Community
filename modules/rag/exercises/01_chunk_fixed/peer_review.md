# Peer Review — Fixed Chunking

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 01_chunk_fixed --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 01_chunk_fixed --lang python`
...
```bash
codam-labs review approve 01_chunk_fixed --lang python --reviewer YOUR_NAME
```
