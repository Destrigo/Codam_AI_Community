# Peer Review — Top-k Retrieval

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_top_k --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_top_k --lang python`
...
```bash
codamlings review approve 04_top_k --lang python --reviewer YOUR_NAME
```
