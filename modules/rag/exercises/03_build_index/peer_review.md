# Peer Review — Build Index

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 03_build_index --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 03_build_index --lang python`
...
```bash
codam-labs review approve 03_build_index --lang python --reviewer YOUR_NAME
```
