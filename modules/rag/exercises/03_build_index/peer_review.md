...
## Before review
- [ ] Your code runs: `codamlings run 03_build_index --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_build_index --lang python`
...
```bash
codamlings review approve 03_build_index --lang python --reviewer YOUR_NAME
```
