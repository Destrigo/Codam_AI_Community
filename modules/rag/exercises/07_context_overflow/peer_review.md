# Peer Review — Context Overflow

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 07_context_overflow --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 07_context_overflow --lang python`
...
```bash
codamlings review approve 07_context_overflow --lang python --reviewer YOUR_NAME
```
