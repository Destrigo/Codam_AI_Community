# Peer Review — Tool Selection

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 02_tool_select --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 02_tool_select --lang python`
...
```bash
codamlings review approve 02_tool_select --lang python --reviewer YOUR_NAME
```
