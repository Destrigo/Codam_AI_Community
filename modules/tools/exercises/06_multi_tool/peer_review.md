...
## Before review
- [ ] Your code runs: `codam-labs run 06_multi_tool --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 06_multi_tool --lang python`
...
```bash
codam-labs review approve 06_multi_tool --lang python --reviewer YOUR_NAME
```
