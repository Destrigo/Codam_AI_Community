# Peer Review — Calculator Tool

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_calculator --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_calculator --lang python`
...
```bash
codamlings review approve 04_calculator --lang python --reviewer YOUR_NAME
```
