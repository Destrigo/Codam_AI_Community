...
## Before review
- [ ] Your code runs: `codam-labs run 05_fetch_url --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_fetch_url --lang python`
...
```bash
codam-labs review approve 05_fetch_url --lang python --reviewer YOUR_NAME
```
