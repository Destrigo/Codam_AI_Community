...
## Before review
- [ ] Your code runs: `codamlings run 03_self_consistency --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_self_consistency --lang python`
...
```bash
codamlings review approve 03_self_consistency --lang python --reviewer YOUR_NAME
```
