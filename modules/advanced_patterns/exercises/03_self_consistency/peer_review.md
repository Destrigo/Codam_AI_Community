# Peer Review — Self-Consistency

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 03_self_consistency --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 03_self_consistency --lang python`
...
```bash
codam-labs review approve 03_self_consistency --lang python --reviewer YOUR_NAME
```
