# Peer Review — Critique and Revise

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_critique_revise --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_critique_revise --lang python`
...
```bash
codamlings review approve 04_critique_revise --lang python --reviewer YOUR_NAME
```
