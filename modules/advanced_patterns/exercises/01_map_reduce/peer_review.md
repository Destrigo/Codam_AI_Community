# Peer Review — Map-Reduce

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 01_map_reduce --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 01_map_reduce --lang python`
...
```bash
codamlings review approve 01_map_reduce --lang python --reviewer YOUR_NAME
```
