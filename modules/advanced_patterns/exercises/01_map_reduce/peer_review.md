...
## Before review
- [ ] Your code runs: `codam-labs run 01_map_reduce --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 01_map_reduce --lang python`
...
```bash
codam-labs review approve 01_map_reduce --lang python --reviewer YOUR_NAME
```
