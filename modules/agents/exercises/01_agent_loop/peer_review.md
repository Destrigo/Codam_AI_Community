...
## Before review
- [ ] Your code runs: `codamlings run 01_agent_loop --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 01_agent_loop --lang python`
...
```bash
codamlings review approve 01_agent_loop --lang python --reviewer YOUR_NAME
```
