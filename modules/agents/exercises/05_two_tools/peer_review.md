# Peer Review — Two Tools

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 05_two_tools --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_two_tools --lang python`
...
```bash
codam-labs review approve 05_two_tools --lang python --reviewer YOUR_NAME
```
