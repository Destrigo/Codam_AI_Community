...
## Before review
- [ ] Your code runs: `codamlings run 03_planner --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_planner --lang python`
...
```bash
codamlings review approve 03_planner --lang python --reviewer YOUR_NAME
```
