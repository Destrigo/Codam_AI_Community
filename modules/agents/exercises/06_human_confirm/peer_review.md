# Peer Review — Human-in-the-Loop

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 06_human_confirm --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 06_human_confirm --lang python`
...
```bash
codamlings review approve 06_human_confirm --lang python --reviewer YOUR_NAME
```
