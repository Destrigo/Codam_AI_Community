...
## Before review
- [ ] Your code runs: `codamlings run 02_max_steps --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 02_max_steps --lang python`
...
```bash
codamlings review approve 02_max_steps --lang python --reviewer YOUR_NAME
```
