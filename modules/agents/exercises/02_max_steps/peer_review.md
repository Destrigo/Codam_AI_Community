# Peer Review — Max Steps

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 02_max_steps --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 02_max_steps --lang python`
...
```bash
codam-labs review approve 02_max_steps --lang python --reviewer YOUR_NAME
```
