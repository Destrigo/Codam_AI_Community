# Peer Review — Scratchpad

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 04_scratchpad --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 04_scratchpad --lang python`
...
```bash
codam-labs review approve 04_scratchpad --lang python --reviewer YOUR_NAME
```
