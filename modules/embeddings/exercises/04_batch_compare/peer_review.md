# Peer Review — Batch Compare

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 04_batch_compare --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 04_batch_compare --lang python`
...
```bash
codam-labs review approve 04_batch_compare --lang python --reviewer YOUR_NAME
```
