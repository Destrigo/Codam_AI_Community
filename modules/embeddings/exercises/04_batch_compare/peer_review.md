...
## Before review
- [ ] Your code runs: `codamlings run 04_batch_compare --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_batch_compare --lang python`
...
```bash
codamlings review approve 04_batch_compare --lang python --reviewer YOUR_NAME
```
