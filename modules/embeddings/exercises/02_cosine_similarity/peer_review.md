# Peer Review — Cosine Similarity

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 02_cosine_similarity --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 02_cosine_similarity --lang python`
...
```bash
codamlings review approve 02_cosine_similarity --lang python --reviewer YOUR_NAME
```
