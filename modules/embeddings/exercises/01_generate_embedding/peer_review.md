...
## Before review
- [ ] Your code runs: `codamlings run 01_generate_embedding --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 01_generate_embedding --lang python`
...
```bash
codamlings review approve 01_generate_embedding --lang python --reviewer YOUR_NAME
```
