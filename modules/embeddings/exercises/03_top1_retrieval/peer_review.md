...
## Before review
- [ ] Your code runs: `codam-labs run 03_top1_retrieval --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 03_top1_retrieval --lang python`
...
```bash
codam-labs review approve 03_top1_retrieval --lang python --reviewer YOUR_NAME
```
