# Peer Review — Top-1 Retrieval

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 03_top1_retrieval --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_top1_retrieval --lang python`
...
```bash
codamlings review approve 03_top1_retrieval --lang python --reviewer YOUR_NAME
```
