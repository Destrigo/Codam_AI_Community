...
## Before review
- [ ] Your code runs: `codam-labs run 01_clear_vs_ambiguous --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 01_clear_vs_ambiguous --lang python`
...
```bash
codam-labs review approve 01_clear_vs_ambiguous --lang python --reviewer YOUR_NAME
```
