# Peer Review — Role Prompting

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 05_role_prompt --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_role_prompt --lang python`
...
```bash
codam-labs review approve 05_role_prompt --lang python --reviewer YOUR_NAME
```
