...
## Before review
- [ ] Your code runs: `codamlings run 05_role_prompt --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 05_role_prompt --lang python`
...
```bash
codamlings review approve 05_role_prompt --lang python --reviewer YOUR_NAME
```
