# Peer Review — Chain-of-Thought

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_chain_of_thought --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_chain_of_thought --lang python`
...
```bash
codamlings review approve 04_chain_of_thought --lang python --reviewer YOUR_NAME
```
