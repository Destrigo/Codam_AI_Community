...
## Before review
- [ ] Your code runs: `codamlings run 03_json_format --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_json_format --lang python`
...
```bash
codamlings review approve 03_json_format --lang python --reviewer YOUR_NAME
```
