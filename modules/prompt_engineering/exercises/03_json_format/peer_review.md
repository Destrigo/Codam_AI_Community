# Peer Review — JSON-Only Output

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 03_json_format --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 03_json_format --lang python`
...
```bash
codam-labs review approve 03_json_format --lang python --reviewer YOUR_NAME
```
