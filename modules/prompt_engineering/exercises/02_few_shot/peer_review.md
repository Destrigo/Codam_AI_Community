# Peer Review — Few-Shot Prompting

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 02_few_shot --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 02_few_shot --lang python`
...
```bash
codamlings review approve 02_few_shot --lang python --reviewer YOUR_NAME
```
