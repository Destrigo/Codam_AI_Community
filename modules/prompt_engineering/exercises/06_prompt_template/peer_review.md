...
## Before review
- [ ] Your code runs: `codamlings run 06_prompt_template --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 06_prompt_template --lang python`
...
```bash
codamlings review approve 06_prompt_template --lang python --reviewer YOUR_NAME
```
