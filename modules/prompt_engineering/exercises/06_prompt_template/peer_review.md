...
## Before review
- [ ] Your code runs: `codam-labs run 06_prompt_template --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 06_prompt_template --lang python`
...
```bash
codam-labs review approve 06_prompt_template --lang python --reviewer YOUR_NAME
```
