# Peer Review — Rate Limiting

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 01_rate_limit --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 01_rate_limit --lang python`
...
```bash
codam-labs review approve 01_rate_limit --lang python --reviewer YOUR_NAME
```
