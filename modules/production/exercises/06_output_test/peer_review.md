# Peer Review — Output Testing

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 06_output_test --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 06_output_test --lang python`
...
```bash
codam-labs review approve 06_output_test --lang python --reviewer YOUR_NAME
```
