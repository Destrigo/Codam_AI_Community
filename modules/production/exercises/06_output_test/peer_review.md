...
## Before review
- [ ] Your code runs: `codamlings run 06_output_test --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 06_output_test --lang python`
...
```bash
codamlings review approve 06_output_test --lang python --reviewer YOUR_NAME
```
