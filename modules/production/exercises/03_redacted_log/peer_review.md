...
## Before review
- [ ] Your code runs: `codamlings run 03_redacted_log --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_redacted_log --lang python`
...
```bash
codamlings review approve 03_redacted_log --lang python --reviewer YOUR_NAME
```
