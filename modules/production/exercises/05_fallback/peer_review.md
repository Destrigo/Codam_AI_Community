...
## Before review
- [ ] Your code runs: `codam-labs run 05_fallback --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 05_fallback --lang python`
...
```bash
codam-labs review approve 05_fallback --lang python --reviewer YOUR_NAME
```
