# Peer Review — Fallback Model

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 05_fallback --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 05_fallback --lang python`
...
```bash
codamlings review approve 05_fallback --lang python --reviewer YOUR_NAME
```
