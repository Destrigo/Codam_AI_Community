...
## Before review
- [ ] Your code runs: `codam-labs run 02_cache --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 02_cache --lang python`
...
```bash
codam-labs review approve 02_cache --lang python --reviewer YOUR_NAME
```
