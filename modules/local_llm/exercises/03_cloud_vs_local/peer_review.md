# Peer Review — Cloud vs Local

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 03_cloud_vs_local --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 03_cloud_vs_local --lang python`
...
```bash
codamlings review approve 03_cloud_vs_local --lang python --reviewer YOUR_NAME
```
