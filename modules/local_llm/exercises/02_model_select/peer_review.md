# Peer Review — Model Selection

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 02_model_select --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 02_model_select --lang python`
...
```bash
codam-labs review approve 02_model_select --lang python --reviewer YOUR_NAME
```
