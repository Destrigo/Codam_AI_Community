# Peer Review — Local Embeddings

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codamlings run 04_local_embeddings --lang python`
- [ ] You tried `codamlings hint` (not `--solution`)
- [ ] Submit: `codamlings review submit 04_local_embeddings --lang python`
...
```bash
codamlings review approve 04_local_embeddings --lang python --reviewer YOUR_NAME
```
