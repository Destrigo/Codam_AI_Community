# Peer Review — Local LLM

Use this checklist **instead of reading `solution/`**. Pair with a classmate.

## Before review
- [ ] Your code runs: `codam-labs run 01_local_call --lang python`
- [ ] You tried `codam-labs hint` (not `--solution`)
- [ ] Submit: `codam-labs review submit 01_local_call --lang python`
...
```bash
codam-labs review approve 01_local_call --lang python --reviewer YOUR_NAME
```
